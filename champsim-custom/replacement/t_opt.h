#ifndef T_OPT_BACKEND_H
#define T_OPT_BACKEND_H
...
class T_OPT
{
    ...
    private:
        /////////////// DATA ////////////
        /* T_OPT parameters */
        /* Modeling a 3MB/core, 16-way set associative T_OPT */
        ...
        // per-datatype T_OPT hit/miss characterization
        int m_numDataTypes;
        ...
        int findRereferenceVal(int vtxID, int currDst);
