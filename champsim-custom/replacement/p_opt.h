...
const uint8_t MAX_REREF {127}; //The maxReref value that the offsetMatrix can trackconst int numMainDataTypes = 5; //allow the application to specify these
...
class P_OPT
{
    ...
    private:
        /////////////// DATA ////////////
        /* P_OPT parameters */
        /* Modeling a 3MB/core, 16-way set associative P_OPT */
        ...
        // per-datatype P_OPT hit/miss characterization
        int m_numDataTypes;
